    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(mContext)
                    .inflate(R.layout.flabby_item_list, parent, false);
        ...
        int color = Color.argb(255, mRandomizer.nextInt(255),mRandomizer.nextInt(255),mRandomizer.nextInt(255));
    ...
    static class ViewHolder {
        ...
        public ViewHolder(View view) {
           // ButterKnife.inject(this, view);
            text = (TextView) ((FlabbyLayout)view).findViewById(R.id.mytext);
        }
    }
}
